 ...
 *
 * A float value that replaces the standard content view corner radius.
 */
@property CGFloat cornerRadius;

/** Content view border width
 *
 * A float value that replaces the standard content view border width.
 */
